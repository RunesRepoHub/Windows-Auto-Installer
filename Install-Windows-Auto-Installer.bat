...
powershell -c "Invoke-WebRequest -Uri 'https://github.com/Eduap-com/WordMat/releases/download/v.1.25/WordMat125-2.exe' -OutFile 'c:\Users\%Username%\Desktop\WordMat.exe'"
